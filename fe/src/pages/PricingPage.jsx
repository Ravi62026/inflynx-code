...
const plans = [
  {
    ...
    features: [
      '500 credits / month',
      '1 workspace',
      '2 AI providers (DeepSeek V4 Flash, Gemini 3.8 Flash)',
      'Basic context window (128k tokens)',
  ...
  },
  {
    ...
    features: [
      '5,000 credits / month',
      '5 workspaces',
      'Frontier providers (Claude Sonnet 5, GPT-6 Astra, Gemini 3.8 Flash)',
      'Full 1,000,000+ token context window',
      'Multi-provider routing (@claude, @gpt, @gemini)',
  ...
  },
  {
    ...
    features: [
      ...
      'All frontier providers (Claude Opus 5, GPT-6 Astra, Gemini 3.8 Flash Cyber) + Ollama/local',
      'Custom 2M+ context budgets',
      'Full multi-provider routing & fallback chains',
      'Team access & RBAC',
